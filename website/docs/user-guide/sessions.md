...
Every conversation — whether from the CLI, Telegram, Discord, Slack, Webex, WhatsApp, Signal, Matrix, Teams, or any other messaging platform — is stored as a session with full message history. Sessions are tracked in:
